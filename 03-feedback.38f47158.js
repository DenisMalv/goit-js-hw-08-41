...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),l={email:a.elements.email,message:a.elements.message,STORAGE_FORM_KEY:"feedback-form-state"},{email:o,message:s,STORAGE_FORM_KEY:r}=l;a.addEventListener("submit",g),a.addEventListener("input",(0,e.default)(m,500));let n={};function m(e){n[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(n)),console.log(n)}function c(){const e=JSON.parse(localStorage.getItem(r));null!=e&&(o.value=e.email,s.value=e.message,console.log(`localStorage при обн. стр. : ${localStorage.getItem(r)}`))}function g(e){e.preventDefault(),console.log("При сабмите формы :",JSON.parse(localStorage.getItem(r))),n={},localStorage.removeItem(r),a.reset()}c();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=https://denismalv.github.io/goit-js-hw-08-41/03-feedback.38f47158.js.map