...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),l={email:a.elements.email,message:a.elements.message,STORAGE_FORM_KEY:"feedback-form-state"},{email:o,message:s,STORAGE_FORM_KEY:m}=l;let r={};function n(e){r[e.target.name]=e.target.value,localStorage.setItem(m,JSON.stringify(r))}function g(){const e=JSON.parse(localStorage.getItem(m));null!=e&&(r=e,console.log("storageItem.email :",e.email),console.log("storageItem.message :",e.message),o.value=e.email?e.email:o.value,s.value=e.message?e.message:s.value,console.log("LOCALE_STORAGE при обн. стр. :",JSON.parse(localStorage.getItem(m))))}function u(e){e.preventDefault(),console.log("LOCALE_STORRAGE При сабмите формы :",JSON.parse(localStorage.getItem(m))),localStorage.removeItem(m),a.reset()}g(),a.addEventListener("submit",u),a.addEventListener("input",(0,e.default)(n,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=https://denismalv.github.io/goit-js-hw-08-41/03-feedback.dc19e8df.js.map