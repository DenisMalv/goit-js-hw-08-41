...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),l={email:a.elements.email,message:a.elements.message,STORAGE_FORM_KEY:"feedback-form-state"},{email:o,message:s,STORAGE_FORM_KEY:n}=l;a.addEventListener("submit",g),a.addEventListener("input",(0,e.default)(c,500));const r={};function c(e){r[e.target.name]=e.target.value,localStorage.setItem(n,JSON.stringify(r)),console.log(r)}function m(){const e=JSON.parse(localStorage.getItem(n));null!=e&&(o.value=e.email,s.value=e.message,console.log(`localStorage при обн. стр. : ${localStorage.getItem(n)}`))}function g(e){e.preventDefault(),console.log("При сабмите формы :",JSON.parse(localStorage.getItem(n))),localStorage.removeItem(n),a.reset()}m();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=https://denismalv.github.io/goit-js-hw-08-41/03-feedback.e8cea389.js.map